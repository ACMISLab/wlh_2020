...
const routes = [
    ...
    {
        path: "/system/resourse/limit",
        component: () => import("@/views/system/resourse"),
        name: "resourseLimit",
        meta: {
            title: "title.resourse-limit",
        },
    },
    {
    ...
    {
        path: "/course/vod/attach",
        component: () => import("@/views/course/vod/attach"),
        name: "CourseAttach",
        meta: {
    ...
    {
        path: "/course/vod/statistics",
        component: () => import("@/views/course/vod/statistics"),
        name: "Statistics",
        meta: {
            title: "title.course.vod.statistics",
        },
    },
    {
    ...
    {
        path: "/ilabEnvironment/container",
        component: () => import("@/views/ilabEnvironment/container"),
        name: "ContainerEdit",
        meta: {
            title: "title.environment.container",
        },
    },
    {
