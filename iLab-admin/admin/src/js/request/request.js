...
const Api = {
    ...
    iLab: {
        ...
        listEnv(query) {
            return get('/ilab/env/list', query);
        },
        listLab(query) {
            return get('/ilab/lab/list', query);
        },
        getEnv(id) {
            return get('/ilab/env/' + id);
        },
        addEnv(data) {
            return post('/ilab/env/add', data);
        },
        updateEnv(data) {
            return post('/ilab/env/edit', data);
        },
        delEnv(id) {
            return post('/ilab/env/delete/' + id);
        },
        getLab(id) {
            return get('/ilab/lab/' + id);
        },
        addLab(data) {
            return post('/ilab/lab/add', data);
        },
        updateLab(data) {
            return post('/ilab/lab/edit', data);
        },
        delLab(id) {
            return post('/ilab/lab/delete/' + id);
        }
