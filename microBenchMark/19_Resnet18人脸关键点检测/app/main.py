...
class FaceDataset(Dataset):
    def __init__(self, data_path, mode='train', val_split=0.1):
        self.mode = mode
...
class FaceNet(paddle.nn.Layer):
    def __init__(self, num_keypoints, pretrained=False):
        ...
        self.outLayer1 = paddle.nn.Sequential(
            paddle.nn.Linear(1000, 16),
            paddle.nn.ReLU(),
            paddle.nn.Dropout(0.1))
        self.outLayer2 = paddle.nn.Linear(16, num_keypoints * 2)
...
model.fit(train_dataset, val_dataset, epochs=EPOCH, batch_size=64)
