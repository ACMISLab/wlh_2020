...
//            }
        ...
        if (StringUtils.equals(EnvConstant.TERMINAL, courseLab.getEnvType())) {
            ...
            labEnvDTO.setLabEnvPath(courseLab.getLabEnvPath());
            ...
            labEnvDTO.setLabEnvPath(EnvConstant.JUPYTER_PATH);
        }
     ...
     */
    @Override
    public Boolean updateLabEnv(CourseChapterDTO chapterDTO) {
        LambdaQueryWrapper<CourseLab> labEnvWrapper = new LambdaQueryWrapper<>();
        labEnvWrapper.eq(CourseLab::getChapterId, chapterDTO.getChapterId());
        CourseLab courseLab = new CourseLab();
        courseLab.setLabEnvPath(chapterDTO.getInitCode());
        courseLabMapper.update(courseLab, labEnvWrapper);
        return true;
    }
